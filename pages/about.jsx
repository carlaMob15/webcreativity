...
import { getAboutPage, getFeaturedTestimonial } from '../lib/sanity-queries'
...
const fallbackData = {
  ...
  howWeWorkDescription: [
    { _type: 'block', children: [{ _type: 'span', text: "Design should feel effortless for the user — but getting there takes collaboration, curiosity, and clarity." }] },
    { _type: 'block', children: [{ _type: 'span', text: "We start each project by understanding your goals, mapping out real user journeys, and sketching ideas by hand. From there, we iterate, prototype, and refine until the experience feels just right." }] }
  ],
...
export async function getStaticProps() {
  try {
    const [aboutPageData, featuredTestimonial] = await Promise.all([
      getAboutPage(),
...
const About = ({ aboutPageData, featuredTestimonial }) => {
